...
/// On-device record of how someone met Baby+ before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.baby", category: "Conversion")
    ...
    static let suiteName = "group.com.jackwallner.baby"
    ...
    private static let impressionPrefix = "baby_"
