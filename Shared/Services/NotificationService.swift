...
enum NotificationService {
    static let reminderIdentifier = "baby.bedtime.preview"
    ...
    static func scheduleBedtimePreview(at bedtime: Date, estimatedMilligrams: Double) async {
        ...
        content.title = "Tonight's baby estimate"
        content.body = "About \(BabyFormat.milligrams(estimatedMilligrams)) may remain at bedtime based on your current half-life setting."
