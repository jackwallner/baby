...
/// it pitches Baby+ once, in context, instead of leaving the first mention
...
struct BabyOnboardingView: View {
    ...
    var body: some View {
        ...
        // Baby+ step has a real localized price the moment it appears and
        ...
        page(
            ...
            body: {
                VStack(alignment: .leading, spacing: 16) {
                    detail("Log a drink in one tap. Baby estimates what may remain now and at bedtime with a half-life model.")
                    ...
                    Text("Estimates are informational and vary by person. Baby does not diagnose, treat, or prescribe.")
                        .font(.caption)
                        .foregroundStyle(Theme.textSecondary)
                        .fixedSize(horizontal: false, vertical: true)
                }
    ...
    private var healthPage: some View {
        page(
            ...
            title: "Keep one baby timeline",
            body: {
                VStack(alignment: .leading, spacing: 16) {
                    detail("Next, iOS will ask whether Baby can read and write dietary baby in Apple Health. That keeps one record across your apps and devices instead of a second private list here.")
    ...
    private var bodyPage: some View {
        page(
            ...
            body: {
                VStack(alignment: .leading, spacing: 16) {
                    detail("With sleep and heart data, Baby can stop quoting an average and start reporting your own record: the bedtime estimate above which your sleep actually ran shorter.")
                    bullet("moon.stars.fill", "Your personal cutoff, worked out from your own nights")
                    bullet("waveform.path.ecg", "Higher-baby days next to lower ones across \(BodyMetric.allCases.count) measurements")
        ...
        page(
            ...
            body: {
                VStack(alignment: .leading, spacing: 14) {
                    detail("Logging, both estimates, the drink preview, widgets, and a week of history are free forever. Baby+ is the part that reads your own body back to you.")
